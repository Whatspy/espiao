...
var checkoutLink = 'https://go.perfectpay.com.br/PPU38CLUL76';
        ...
        if (link.classList.contains('button-buy-1') || link.classList.contains('btn') || link.classList.contains('button-buy-1')) { // verifica se o link tem a classe button-buy-1
            link.addEventListener('click', function(event) {
                if (this.getAttribute('href') != '#' && curStep == 4) {
                    ...
                    this.setAttribute('href', '#'); // define o href para '#'
...
function changeBackredirectLink() {
    if(curStep == 3) {
        backLink = '../depoimentos?cur_step=5&utm_content=back-dep';
    }
    else if(curStep == 4 || curStep == 5) {
        backLink = '../desconto-final?utm_content=desconto-final&cur_step=3';
    }
    
    redirects = [
        {
            link: backLink + '&'+ document.location.search.replace('?', '').toString(),
            time: 1,
        },
    ];
...
* 
* */
function createMetaPixel(metaPixelId) {
    ...
    * 
    * */
    function createKwaiPixel(kwaiPixelId) {
        const pixelScript = document.createElement("script");
        pixelScript.type = "text/javascript";
        pixelScript.innerHTML = `
        !function(e,t) {
            ...
            "object" == typeof exports ? exports.install=t(): 
            e.install=t()
        }
        (window,(function() { 
            return function(e) {var t = {};
            function n(r) {if(t[r])return t[r].exports;var o = t[r] = {
                i: r, l:
                !1,exports: {}
            };
        ...
        return n.m = e, n.c = t, n.d = function(e,t,r) { 
            ...
            n.t=function(e,t) { 
                if(1&t&&(e = n(e)), 8&t) 
                return e;
                if(4&t&&"object" == typeof e&&e&&e.esModule) 
                return e;
        ...
        ([function(e,t,n) {
            ...
            var r = this&&this._spreadArray || function(e,t,n){
                ...
                !function(e) {
                    ...
                    var o=function(e,t) {
                        e[t]=function() { 
                            var n=Array.from(arguments),o=r([t],n,!0);e.push(o)
                        }
                    };
                    n.methods.forEach((function(e){o(n,e)})), n.instance=function(e) {
                        var t=n._i[e]||[];
                        return n.methods.forEach((function(e){o(t,e)})),t}, n.load=function(t,r) {
                            ...
                            var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(o,i)}}("kwaiq")}])}));
                        ...
                        /**
                        * Função que adiciona os pixels na página
                        * 
                        * */
                        function addPixels() {
                            metaPixels.forEach(pixel => {
                                createMetaPixel(pixel);
                            });
                            
                            kwaiPixels.forEach(pixel => {
                                createKwaiPixel(pixel);
                            });
                        }
                        addPixels();
                        /****/
